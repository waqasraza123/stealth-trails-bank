...
import { CustomerSessionRiskPage } from "@/pages/CustomerSessionRiskPage";
...
const navItems = [
  ...
  { label: "Session Risk", path: "/session-risk" },
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/session-risk" element={<CustomerSessionRiskPage />} />
